...
plugins {
    id("no.beint.thim.settings") version "0.13.0"
}
```
...
java -jar benchmark/build/libs/benchmark-0.13.0-jmh.jar TemplateCompilerBenchmark \
